#ifndef GUARD_AGB_AGB_IO_REGS_H
#define GUARD_AGB_AGB_IO_REGS_H
...
#define REG_DMA         ((volatile dma_control *)(REG_BASE + REG_OFFSET_DMA0))
...
#define REG_SIOMULTI(n) (*(volatile uint16_t *)(REG_ADDR_SIOMULTI0 + (n) * 2))
